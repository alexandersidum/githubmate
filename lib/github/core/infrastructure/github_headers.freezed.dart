...
abstract class $GithubHeadersCopyWith<$Res> {
  ...
  $Res call({@HiveField(0) String? etag, @HiveField(1) PaginationLink? link});
...
abstract class _GithubHeaders extends GithubHeaders {
  const factory _GithubHeaders(
      {@HiveField(0) final String? etag,
      @HiveField(1) final PaginationLink? link}) = _$_GithubHeaders;
...
abstract class $PaginationLinkCopyWith<$Res> {
  ...
  $Res call({@HiveField(0) int maxPage});
}
...
class _$_PaginationLink extends _PaginationLink {
  const _$_PaginationLink({@HiveField(0) required this.maxPage}) : super._();
...
abstract class _PaginationLink extends PaginationLink {
  const factory _PaginationLink({@HiveField(0) required final int maxPage}) =
      _$_PaginationLink;
